...
static const int64_t STATIC_POS_REWARD = 3 * COIN; //Constant reward of 3.5 LEGN per COIN
static const int64_t TARGET_SPACING = 1 * 60; // 1 min per Block
static const int64_t TARGET_SPACING2 = 1 * 60; // 1 min per Block
...
static const int64_t MAX_MONEY = 100000000 * COIN; // 100M PoW coins
...
inline int64_t GetMNCollateral(int nHeight) { return 100000; } // Changed from 5000 to 100,000
